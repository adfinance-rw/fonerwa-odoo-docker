...
class StockReportWizard(models.TransientModel):
    ...
    def _get_initial_stock(self, product):
        ...
        return self._get_stock_at_date(product, self.date_from)
    ...
    def generate_report(self):
        ...
        for product in products:
            ...
            stock_data = self._get_stock_data(product)
            if stock_data['quantity'] == 0 and not self.product_ids:
                continue  # Skip products with no stock unless specifically selected
